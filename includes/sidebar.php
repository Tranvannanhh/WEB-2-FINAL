    ...
    <div class="sidebar-brand">
        <a href="<?= APP_URL ?>/index.php" class="brand-link">
            <div class="brand-icon">
                <img src="<?= APP_URL ?>/assets/img/vnuis-logo.png" alt="VNU-IS Logo" style="width:36px;height:36px;object-fit:contain;border-radius:6px;background:#fff;padding:2px;">
            </div>
